...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="fadein" class="container">
			...
			<div class="row">
			<h1>CREATE QR CODE FOR PHYSICAL DOCUMENT</h1>
			
				<div class="alert alert-info">
				<strong>ATTENTION!</strong> If you want to create flow later, just go to the main menu then go to <b>CREATE FLOW SECTION</b>.
				</div>
				<!-- ------------------------------------------------------------------------------------- -->
				<!-- alert Successful qr generate-->
				<?php if(isset($_SESSION['gpdoc'])) { ?>
				<div class="alert alert-success">
				<strong>Success!</strong> QR generated for physical document. To view the file, click <a href="pdocs.php">here</a>. If you want to create a flow for the passing of document,
				click <a href="flows.php" style="color: red;">here</a>.
				</div>
				
				 
				<?php unset($_SESSION['gpdoc']); } ?>
				
				<!-- alert failed qr generate-->
				<?php if(isset($_SESSION['fpdoc'])) { ?>
				<div class="alert alert-danger">
				<strong>Failed!</strong> QR for physical document not generated.
				</div>
				 
				<?php unset($_SESSION['fpdoc']); } ?>
				<!-- ------------------------------------------------------------------------------------- -->
				<br>
				...
				<label for="male">File To Upload</label> <i>(Upload the front page picture of the physical document)</i>
				...
				<i>Press create button to create the qr code</i>
				<br>
				<input type="submit" name="p_generateqr" value="Create" style="width: 20%; padding: 14px 20px; margin: 8px 0; border: none; border-radius: 4px;">
