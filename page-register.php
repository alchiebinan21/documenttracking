						...
						<div class="basic-login">
							<form role="form" method="post" action="success.php">
								<div class="form-group">
									...
									<input class="form-control" id="register-username" name="fn" type="text" placeholder="" required> 
								</div>
								<div class="form-group">
		        				 	<label for="register-username"><i class="icon-user"></i> <b>Lastname</b></label>
									<input class="form-control" id="register-username" name="ln"type="text" placeholder="" required>
								</div>

								<div class="form-group">
		        				 	<label for="register-username"><i class="icon-user"></i> <b>Position</b></label>
		        				 	<input class="form-control" id="register-username" name="position" type="text" placeholder="" required> 
								</div>
								<div class="form-group">
		        				 	<label for="register-username"><i class="icon-user"></i> <b>Department</b></label>
		        				 	<input class="form-control" id="register-username" name="department" type="text" placeholder="" required> 
								</div>
								<div class="form-group">
		        				 	<label for="register-username"><i class="icon-user"></i> <b>Username</b></label>
									<input class="form-control" id="register-username" name="un"type="text" placeholder="" required>
								</div>
								<div class="form-group">
		        				 	<label for="register-username"><i class="icon-user"></i> <b>Email</b></label>
									<input class="form-control" id="register-username" name="email" type="email" placeholder="" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input class="form-control" id="register-password2" name="repassword" type="password" placeholder="" required>
								</div>
								<div class="form-group">
									<button type="submit" name="submit" class="btn pull-right" value="Register" >Register</button>
